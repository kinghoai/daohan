...
<div id="post-1062" class="post-1062 page type-page status-publish hentry">
                            ...
                            <div
                                ...
                                <div class="col content-wrapper link-area-box icon-hover-animation-slide"
                                    ...
                                    <div class="heading heading-with-icon icon-left">
                                        ...
                                        <div class="content-box-heading" style="font-size: 20px;line-height:23px;">
                    ...
                    <div class="fusion-one-half fusion-layout-column fusion-spacing-yes"
                        ...
                        <div class="fusion-column-wrapper">
                            <div class="fusion-title title sep-underline sep-solid fusion-title-size-one"
                                 style="border-bottom-color:#e5e5e5;margin-top:0px;margin-bottom:0px;"><div
                                    class="title-heading-left"><span
                                        style="color: #ffffff; font-size:22px; font-weight: bold; "><?php echo get_post_meta($post->ID,TITLE_BLOCK.'title-block',true);?></span></div></div>
                ...
                <div class="fusion-row">
                    <div
                        ...
                        if ($all_args2->have_posts()): while ($all_args2->have_posts()): $all_args2->the_post();
                            ?>
                            <div
                                class="fusion-column content-box-column content-box-column-<?php echo $j;?> col-lg-4 col-md-4 col-sm-4 fusion-content-box-hover content-box-column-first-in-row">
                                <div class="col content-wrapper link-area-box icon-hover-animation-slide"
                                     style="background-color:rgba(255,255,255,0);">
                                    <div class="heading heading-with-icon icon-left">
                                        <div class="icon"><i
                    ...
                    <div
                        ...
                        <div class="fusion-row">
                            ...
                            <div class="fusion-one-half fusion-layout-column fusion-column-last fusion-spacing-yes"
                                ...
                                <div class="fusion-column-wrapper">
                                    <div class="fusion-title title sep-underline sep-solid fusion-title-size-one"
                                         style="border-bottom-color:#e5e5e5;margin-top:0px;margin-bottom:0px;">
                                         <a href="<?php the_permalink(); ?>" title="<?php the_title()?>">
                                         <h2 class="title-heading-left"><span
                                                style="color: #ff0000;"><?php the_title(); ?></span></h2></a></div>
                                    <p><span style="color: #000000; font-weight: 400;">
                                            <?php the_excerpt(); ?>
                                    </span>
                                    </p>
                                    ...
                                    <div class="fusion-button-wrapper">
                                        <a class="fusion-button button-flat button-round button-large button-default button-2"
                                           target="_self" href="<?php the_permalink(); ?>" title="<?php the_title()?>"><i
                                                ...
                                                class="fusion-button-text"><?php echo 'Xem hồ sơ đáo hạn'?></span></a>
                                    </div>
                                    <div class="fusion-clearfix"></div>
                                </div>
                            </div>
                                    ...
                                    <div class="fusion-button-wrapper">
                                        ...
                                        <a class="fusion-button button-flat button-round button-large button-default button-3"
                                           target="_self" href="<?php the_permalink(); ?>" title="<?php the_title()?>"><span
                                                class="fusion-button-text"><?php echo 'Xem hồ sơ đáo hạn' ?></span><i
            ...
            <div
                ...
                <div class="fusion-row"><h3
                        style="text-align: center;"><?php _e('ĐỐI TÁC CỦA CHÚNG TÔI', 'nganhang') ?></h3>
                ...
                <div class="fusion-row">
                    <div class="fusion-three-fourth fusion-layout-column fusion-spacing-yes"
                        ...
                        <div class="fusion-column-wrapper">
                            ...
                            <div style="text-align: center;"><span style="color: #3B5998; font-size: 22px; font-weight: bold; text-shadow: 0 2px 1px rgba(255, 255, 255, 1);"><?php echo get_post_meta($post->ID,TITLE_BLOCK.'thong-diep-ngan',true)?></span>
                            </div>
                        ...
                        <div class="fusion-column-wrapper">
                            <div class="fusion-button-wrapper fusion-aligncenter">
                                ...
                                <a class="fusion-button button-flat button-round button-xlarge button-custom button-6"
                                   target="_self" href="<?php echo get_post_meta($post->ID,TITLE_BLOCK.'link-button',true)?>" title="<?php the_title()?>"><span
            ...
            <div
                ...
                if($all_argsp->post_count>0):?>
                <div class="fusion-row"><h3 style="text-align: center;"><?php _e('TIN TỨC MỚI NHẤT','nganhang')?></h3>
                                ...
                                <div class="fusion-flexslider flexslider flexslider-hover-type-none">
                                    <ul class="slides">
                                        <li><a href="<?php the_permalink();?>"
                                               class="hover-type-none" title="<?php the_title();?>"><?php the_post_thumbnail('thumbnail');?></a></li>
                                    </ul>
                                </div>
				...
				<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>" title="Đăng bởi <?php the_author()?>" rel="author"><?php the_author();?></a>			</span>
                                    ...
                                    <p class="meta"><span><span
                                            ...
                                            class="meta-separator">|</span><span><a
                                                href="<?php the_permalink()?>#respond"><?php echo wp_count_comments($post->ID)->total_comments;?> Bình luận</a></span></p>
